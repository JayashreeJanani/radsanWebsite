...
//for api: GET /api/job_application
	@GetMapping
	public List<Job_application> getAllApplications(){
		return jobApplicationService.getAllJobApplications();
	}
	
//for api: GET/api/job_application/{id}
	@GetMapping("/{id}")
	public Job_application getApplicationById(@PathVariable Integer id) {
		return jobApplicationService.getJobApplicationById(id);
	}
	//for api: POST /api/job_application
	@PostMapping
	public Job_application createApplication(@RequestBody Job_application job_application) {
